...
mlflow.set_experiment("VisitWithUs_MLOps_CICD_experiment")

api = HfApi()


Xtrain_path = "hf://datasets/pal14/visitWithUs/Xtrain.csv"
Xtest_path = "hf://datasets/pal14/visitWithUs/Xtest.csv"
ytrain_path = "hf://datasets/pal14/visitWithUs/ytrain.csv"
ytest_path = "hf://datasets/pal14/visitWithUs/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_classification_model_visitWithUs.joblib"
    ...
    repo_id = "pal14/visitWithUs_classification-model"
    repo_type = "model"
    ...
    # create_repo("best_classification_model_visitWithUs-model", repo_type="model", private=False)
    api.upload_file(
        path_or_fileobj="best_classification_model_visitWithUs.joblib",
        path_in_repo="best_classification_model_visitWithUs.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
